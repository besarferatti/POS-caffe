...
export function OrderWorkspace({ tables, categories, products, openOrders }: { tables: Table[]; categories: Category[]; products: Product[]; openOrders: Order[] }) {
