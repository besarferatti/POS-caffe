  ...
  return (
    <div className="min-h-screen md:grid md:grid-cols-[16rem_1fr]">
      <aside className="border-b bg-card p-5 md:min-h-screen md:border-b-0 md:border-r">
        <Link href="/app" className="text-lg font-bold tracking-tight text-primary">POS CAFFÈ</Link>
        <nav className="mt-8 space-y-1"><Link className="block rounded-md bg-accent px-3 py-2 text-sm font-medium" href="/app">Workspace</Link>{canManageStaff && <Link className="block rounded-md px-3 py-2 text-sm text-muted-foreground hover:bg-accent hover:text-foreground" href="/app/staff">Staff</Link>}</nav>
